...
<tr>
	<td colspan="2">
		<div id="lang" align="right">{$LNG.intro_lang}:&nbsp;<select class="styles-select" id="lang" name="lang" onchange="document.location = '?lang='+$(this).val();">{html_options options=$Selector selected=$lang}</select></div>
		...
		<div class="line">
			<a class="read-more" href="index.php?mode=install&step=1">{$LNG.continue}</a>
		</div>
	</td>
</tr>
{if $canUpgrade}
