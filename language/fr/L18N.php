...
//SERVER GENERALS
$LNG['dir']         	= 'ltr';
$LNG['week_day']		= array('Dim', 'Lun', 'Mar', 'Mer', 'Jeu', 'Ven', 'Sam'); # Start with Sun!
$LNG['months']			= array('Jan', 'Fev', 'Mar', 'Avr', 'Mai', 'Jun', 'Jul', 'Aout', 'Sep', 'Oct', 'Nov', 'Dec');
$LNG['js_tdformat']		= '[D] [d] [M] [H]:[i]:[s]';
...
$LNG['short_minute']	= 'm';
$LNG['short_second']	= 's';
$LNG['short_milliseconde']	= 'ms'; // passage en millisecondes .
