...
// Translated into English by QwataKayean . All rights reversed (C) 2015
// SpaceUni - Copyright (C) 2015 Danter14
...
$LNG['intro_welcome']			= 'Hello user of SpaceUni!';
$LNG['intro_text']				= 'The SpaceUni is one of the best projects of OGame.<br>The SpaceUni is the newest and most stable of XNova currently developed. SpaceUni is remarkable for its ease of stability, flexibility, dynamism, quality and utilization. we always expect to be better than your expectations.<br><br>The installation system will guide you through the installation or upgrading from a previous version to the latest one. Each question, a problem, please dont hesitate to ask our development and support in case of doubt!<br><br>The SpaceUni is an Open Source project, licensed under the GNU GPL v3. For this to be verified, please click the link above where it refers to "lincense"<br><br>Before the installation can be started a small test to see if your plan/domain has all the requirements to support the SpaceUni';
$LNG['intro_upgrade_head']		= 'SpaceUni already installed?';
$LNG['intro_upgrade_text']		= '<p>You have already installed SpaceUni and want easy updating?</p><p>Here you can update your old database with just a few clicks!</p>';
...
$LNG['upgrade_required_rev']	= 'The Updater can work only from revision r1 (SpaceUni v1.0) or later.';
...
$LNG['licence_accept']			= 'To continue the installation of SpaceUni, you need to agree to the terms and conditions of lincense of SpaceUni';
...
$LNG['req_desc']				= 'Before the installation proceed, SpaceUni will be some tests to verify that your server supports the SpaceUni, so ensure that the SpaceUni can be installed. Its suggested that you read carefully the results, and do not proceed until all these be checked.';
$LNG['reg_yes']					= 'Yes';
$LNG['reg_no']					= 'No';
$LNG['reg_found']				= 'Found';
...
$LNG['req_php_need_desc']		= '<strong>Required</strong> — PHP is the language code base of SpaceUni. This is the required PHP version 5.2.5 or higher so that all modules work correctly';
...
$LNG['reg_global_desc']			= 'SpaceUni will also work, if this configuration is installed on your server. However, it is recommended for security reasons, disable "register_globals" in PHP installation, if that is possible.';
$LNG['req_ftp_head']			= 'Insert information of FTP';
$LNG['req_ftp_desc']			= 'Write your information from FTP so SpaceUni automatically fix problems. Alternatively, you can also manually assign permissions to write.';
$LNG['req_ftp_host']			= 'Hostname';
$LNG['req_ftp_username']		= 'User name';
$LNG['req_ftp_password']		= 'Password';
$LNG['req_ftp_dir']				= 'Directory of SpaceUni';
...
$LNG['step1_titre']				= 'Infomer les champs pour vous connecter à votre base de donnée';
$LNG['step1_head']				= 'Configure the installation database';
$LNG['step1_desc']				= 'Now that it has been determined that SpaceUni can be installed on your server, s should provide some information. If you dont know how to run a link database, contact your hosting provider first or with the SpaceUni forum for help and support. When you insert the data, checks were introduced properly';
...
$LNG['step2_db_done']			= 'The connection to the database was <span style="color:lime;">successful!</span>';

$LNG['step3_head']				= 'Create database tables';
$LNG['step3_desc']				= 'The tables needed for the SpaceUni database already have been created and populated with default values. To go to the next step, conclude the installation of SpaceUni';
$LNG['step3_db_error']			= 'Failed to create the database tables:';

$LNG['step4_titre']				= 'Création du compte Admin';
$LNG['step4_titre_ok']			= 'Information';
